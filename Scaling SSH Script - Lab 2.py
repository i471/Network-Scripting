...
def Session1():
      ...
      remote_conn_pre.set_missing_host_key_policy(paramiko.A
      utoAddPolicy())
      remote_conn_pre.connect(ipaddr1, username=username,
      password=password, look_for_keys= False, allow_agent=
      False)
...
def Session2():
      ...
      remote_conn_pre.set_missing_host_key_policy(paramiko.A
      utoAddPolicy())
      remote_conn_pre.connect(ipaddr2, username=username,
      password=password, look_for_keys= False, allow_agent=
      False)
      remote_conn = remote_conn_pre.invoke_shell()
      remote_conn.send("terminal length 0\n")
...
def Session3():
      ...
      remote_conn_pre.set_missing_host_key_policy(paramiko.A
      utoAddPolicy())
      remote_conn_pre.connect(ipaddr3, username=username,
      password=password)
      remote_conn = remote_conn_pre.invoke_shell()
      remote_conn.send("terminal length 0\n")
      remote_conn.send("enable\r")
...
def Session4():
      ...
      remote_conn_pre.set_missing_host_key_policy(paramiko.A
      utoAddPolicy())
      remote_conn_pre.connect(ipaddr4, username=username,
      password=password, look_for_keys= False, allow_agent=
      False)
      remote_conn = remote_conn_pre.invoke_shell()
      remote_conn.send("terminal length 0\n")
